...
export const Hero = ({ movie, thumbnails }: HeroProp) => {
    ...
    const[showDescription, setShowDescription] = useState(false);4
    const shortDesc = movie.description.slice(0, 90);

    return(
        <section className="hero" style={{backgroundImage: 'url(${movie.backdropUrl})'}}>
            <div className="hero-overlay" />
            <div className="hero-content">
                <p className="hero-pesents">Angel Studios Present</p>
                ...
                <p className="hero-description">
                    ...
                    {!showDescription && (
                        <button className="hero-more-btn" onClick={() => setShowDescription(true)}>...more</button>
                    )}
                </p>
